...
namespace DiscordStatus
{
    public class DiscordStatusPlugin : MelonPlugin
    {
        ...
        public void UpdateActivity()
        {
            ...
            activity.Assets.LargeImage = $"/IMG/fatbebe.jpg"; // big picture
            activity.Assets.SmallImage = $"/IMG/hai.jpg"; // small picture
            ...
            activity.Name = $"{MelonUtils.CurrentGameAttribute.Name}";
